...
<div id="content">
  ...
  <div class="admin show">
    ...
    <div class="actions">
      <a class="action" href="<?php echo get_url('/staff/admins/edit.php?id=' . h(u($admin['id']))); ?>">Edit</a>
      <a class="action" href="<?php echo get_url('/staff/admins/delete.php?id=' . h(u($admin['id']))); ?>">Delete</a>
    </div>
